...
class GPTService:
    ...
    def call_gpt(self, registration_text):
        try:
            ...
            messages = [
                {"role": "system", "content": '''
                                                    ...
                                                    1. ‘기록사항 없음’의 경우
                                                    → [안전]
                                                    2. “등기목적"열의 내용이 ‘근저당권설정'인 행이 있는 경우
                                                    → 집주인이 주택담보대출을 갚지 못 할 경우 보증금을 전부 돌려받지 못 할 수 있음 [위험]
                                                    (집주인이 대출금을 갚지 못 해 경매로 넘어갈 경우 돌려받을 수 있는 금액) = (보증금) - (해당 행의 “권리자 및 기타사항”에 나타나는 ‘채권최고액’에 해당하는 금액)
                 '''},
